...
public class WeekView extends View {
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
    	...
    	if (mCurrentScrollDirection == Direction.VERTICAL) {
            ...
            else if (mCurrentOrigin.y - mDistanceY < -(mHourHeight * 10 + mHeaderTextHeight + mHeaderRowPadding * 2 - getHeight())) mCurrentOrigin.y = -(mHourHeight * 10 + mHeaderTextHeight + mHeaderRowPadding * 2 - getHeight());
